...
export const mineTokens = async (amount) => {
    ...
    if (AfterBalance >= 100000 && OGBalance < 100000){
        ...
        template.prize = "a Vacation Day"
         sendEmail();
        return (<div><h3>Congrats! You have walked more than 1000km total! You have earned a 1000km NFT</h3><p>Now you can qualify to earn a Vacation day by April 16th</p></div>)
    }

    if (AfterBalance >= 50000){
        await giveNFT(500);
        template.distance = 500;
        template.prize = "A pair of running shoes or a Yoga Mat"
         sendEmail();
        return  (<div><h3>Congrats! You have walked more than 500km total! You have earned the 500km NFT</h3><p>now you can qualify to earn a Yoga Mat or running shoes by April 16th. Continue to run or walk to earn vacation day instead!</p></div>)
    }
    ...
    if (AfterBalance >= 25000 && OGBalance < 25000){
        ...
        sendEmail();
        return (<div><h3>Congrats! You have walked more than 250km total! You have earned the 250km NFT </h3><p>Now you can qualify to earn a Water Bottle by April 16th. Continue to run or walk to earn running shoe or vacation day instead!</p></div>)
    }

    if (AfterBalance >= 10000 && OGBalance < 10000){
        await giveNFT(100);
        template.distance = 100;
        template.prize = "running socks"
        sendEmail();
        return (<div><h3>Congrats! You have walked more than 100km total! You have earned the 100km NFT </h3><p>Now you can qualify to earn a pair of running socks by the end of April. Continue to run or walk to earn running shoe or vacation day instead!</p></div>)
